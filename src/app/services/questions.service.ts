...
export class QuestionsService {
  ...
  allQuestions(){
    this.http.get('/api/questions/all')
  ...
  byStudentId(id){
    this.http.get('/api/questions/student/'+id)
    .subscribe((res: APIResponse) => {
      let data: InstructorQuestion[] = res.data
      this.store.dispatch(Actions.setInstructorQuestions({instructorQuestions: data}))
  })}
  ...
  byLessonId(id){
    this.http.get('/api/questions/lesson/'+id)    
    .subscribe((res: APIResponse) => {
      let data: InstructorQuestion[] = res.data
      this.store.dispatch(Actions.setInstructorQuestions({instructorQuestions: data}))
  })}
  ...
  byTopic(topicId, cohortId){
    this.http.post('/api/questions/topic', {topicid: topicId, cohortid: cohortId})    
    .subscribe((res: APIResponse) => {
      let data: InstructorQuestion[] = res.data
      this.store.dispatch(Actions.setInstructorQuestions({instructorQuestions: data}))
  })}
  ...
  editQuestion(id, question, answer){
    this.http.put('/api/questions/edit', {question_text: question, question_answer: answer, id: id})    
    .subscribe((res: APIResponse) => {
      if(res.success){
        this.allQuestions()
      }
  ...
  questionQuestion(question: InstructorQuestion){
    this.http.post('/api/questions/new', question)    
    .subscribe((res: APIResponse) => {
      if(res.success){
        this.allQuestions()
      }
  ...
  deleteQuestion(id){
    this.http.delete('/api/questions/delete/'+id)
    .subscribe((res: APIResponse) => {
      if(res.success){
        this.allQuestions()
      }
